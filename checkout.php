            ...
            echo'
                <div class="col-75">
                    ...
                    <label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Shipping address same as billing
                            ...
                            ?>
                            <script 
                            src="https://checkout.stripe.com/checkout.js" class="stripe-button" value="stripe-button"
                            data-key="<?php echo $publishableKey?>"
                            data-amount=<?php echo str_replace(",","",$total) * 100?>
                            data-name="<?php echo "Online Payment With Card"; ?>" 
